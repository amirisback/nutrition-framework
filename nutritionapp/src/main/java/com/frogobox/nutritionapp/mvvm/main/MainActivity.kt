    ...
    private fun data(): MutableList<Menu> {
        ...
        data.add(
            Menu(
                ...
                Intent(this, UiComponentActivity::class.java)
            )
        )
        data.add(
            Menu(
                Constant.TitleActivity.ACTIVITY_ANDROID_METHOD,
                Intent(this, AndroidMethodActivity::class.java)
            )
        )
        data.add(
            Menu(
                Constant.TitleActivity.ACTIVITY_ARTICLE,
        ...
        data.add(
            Menu(
                ...
                Intent(this, KebutuhanEnergiActivity::class.java)
            )
        )
        data.add(
            Menu(
                Constant.TitleActivity.ACTIVITY_CALCULATOR_INDEX_MASA_TUBUH,
                Intent(this, IndexMasaTubuhActivity::class.java)
            )
        )
        data.add(
            Menu(
                Constant.TitleActivity.ACTIVITY_CALCULATOR_BERAT_BADAN_IDEAL,
                Intent(this, BeratBadanIdealActivity::class.java)
            )
        )
        return data
    }
