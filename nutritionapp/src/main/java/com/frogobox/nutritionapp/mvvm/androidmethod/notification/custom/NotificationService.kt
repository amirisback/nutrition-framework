...
import com.frogobox.nutritionframework.notification.NutriNotifActionRemoteInputListener
...
class NotificationService : IntentService("NotificationService") {
    ...
    private fun showNotification() {
        ...
        NutriNotification.Inject(this)
            ...
            .setupShowWhen()
            .setupActionRemoteInput(object : NutriNotifActionRemoteInputListener {
                ...
                override fun setActionIcon(): Int {
                    return R.drawable.ic_nutri_notification_send
                }
