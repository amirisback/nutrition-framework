...
object NutriRvConstant {
    ...
    const val NUTRI_ADAPTER_R_CLASS = "NUTRI_ADAPTER_R_CLASS"
    const val NUTRI_ADAPTER_VIEW_BINDING = "NUTRI_ADAPTER_VIEW_BINDING"
    const val NUTRI_ADAPTER_MULTI = "NUTRI_ADAPTER_MULTI"
    const val NUTRI_RV_TAG = "NutriRecyclerView"
    const val NUTRI_RV_COMPOSE_TAG = "NutriRecyclerCompose"
