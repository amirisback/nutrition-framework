package com.frogobox.nutritionframework.notification
...
class NutriNotification {
    ...
    class Inject(val context: Context) : INutriNotification {

        private val TAG = NutriNotification::class.java.simpleName
        ...
        private var smallIcon: Int = R.drawable.ic_nutri_notification_notif
        ...
        private var notificationID: Int = NutriNotifConstant.FROGO_NOTIFICATION_ID
        private var channelID: String = NutriNotifConstant.FROGO_CHANNEL_ID
        private var channelName: String = NutriNotifConstant.FROGO_CHANNEL_NAME
        ...
        override fun setupActionRemoteInput(listener: NutriNotifActionRemoteInputListener): Inject {
        ...
        override fun setupInboxStyle(listener: NutriNotifInboxStyleListener): Inject {
        ...
        override fun setCustomContentView(listener: NutriNotifCustomContentViewListener): Inject {
        ...
        override fun setCustomBigContentView(listener: NutriNotifCustomContentViewListener): Inject {
        ...
        override fun setupWithFrogoStyle(): Inject {
            this.contentTitle = context.resources.getString(R.string.nutri_content_title)
            this.contentText = context.resources.getString(R.string.nutri_content_text)
            this.contentSubText = context.resources.getString(R.string.nutri_subtext)
            this.largeIcon = R.drawable.ic_nutri_notification_notif
